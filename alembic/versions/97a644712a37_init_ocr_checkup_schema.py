...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_checkup_metric_results_record_id"),
        "checkup_metric_results",
        ["record_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_checkup_records_file_hash"), "checkup_records", ["file_hash"], unique=False
    )
    op.create_index(
        op.f("ix_checkup_records_user_id"), "checkup_records", ["user_id"], unique=False
    )
    op.create_unique_constraint(
        "uq_checkup_records_user_file_hash", "checkup_records", ["user_id", "file_hash"]
    )
    op.create_table(
        "meal_records", sa.Column("id", sa.Integer(), nullable=False), sa.PrimaryKeyConstraint("id")
    )
    op.create_table(
        "ocr_jobs",
        sa.Column("id", sa.Integer(), nullable=False),
